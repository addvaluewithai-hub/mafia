...
export const STORY_CATALOG = [
  ...
  { id: 'birthday-envelope', playerCount: 6, packId: 'home-social', title: 'ظرف عيد الميلاد', teaser: 'ظرف هدية اختفى بعد ما نسخة مؤقتة من مفتاح الدرج ظهرت وسط زحمة التورتة.' },
