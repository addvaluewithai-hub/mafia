-- Make computer-player identity an explicit server snapshot contract.
-- Clients must not infer bot identity from nickname prefixes; nickname remains the visible identity.
