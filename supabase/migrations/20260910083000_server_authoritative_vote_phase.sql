-- Make gameplay phase and per-player vote eligibility explicit in the server snapshot.
-- The client should not infer whether voting is open from round counters.
